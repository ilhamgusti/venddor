                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-sm-2 col-form-label text-right">Nama Proyek</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" name="nama_proyek" type="text" value="{{--$data->nama_proyek--}}" id="example-text-input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-email-input" class="col-sm-2 col-form-label text-right">Tanggal Pengerjaan</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" name="tanggal_pengerjaan" type="date" value="{{--$data->tanggal_pengerjaan--}}" id="example-email-input">
                                                </div>
                                            </div> 
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group">
                                                        <input id="estimasi" type="number" name="estimasi" value="{{--$data->estimasi--}}" class="form-control" placeholder="Estimasi hari" aria-label="Estimasi...">
                                                        <span class="input-group-append">
                                                            <button disabled class=" disabled btn btn-sm btn-secondary pointer-event-none shadow-none" type="button">Hari</button>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row d-none">
                                                <label for="example-password-input" class="col-sm-2 col-form-label text-right">Status</label>
                                                <div class="col-sm-10">
